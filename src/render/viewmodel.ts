...
function buildWarlockRig(): ViewmodelRig {
  ...
  return {
    ...
    continuous(dt, ctx) {
      ...
      updateChannelBeam(channeling && !!actionState.channelEndPoint, beamFromScratch, actionState.channelEndPoint ?? undefined, WARLOCK_BEAM_COLOR, actionState.channelGirth);
    },
  };
}
